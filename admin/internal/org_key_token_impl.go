...
func (o *OrgTokenService) Gets(ctx context.Context, orgID string) (*model.OrgTokenPageScheme, *model.ResponseScheme, error) {
	return o.internalClient.Gets(ctx, orgID)
}
...
func (o *OrgKeyService) Gets(ctx context.Context, orgID string) (*model.OrgKeyPageScheme, *model.ResponseScheme, error) {
	return o.internalClient.Gets(ctx, orgID)
}
...
func (i *internalOrgKeyImpl) Gets(ctx context.Context, orgID string) (*model.OrgKeyPageScheme, *model.ResponseScheme, error) {
...
func (i *internalOrgTokenImpl) Gets(ctx context.Context, orgID string) (*model.OrgTokenPageScheme, *model.ResponseScheme, error) {
