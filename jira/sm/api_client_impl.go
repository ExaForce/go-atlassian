...
// New creates a new Jira Service Management client. Callers that need retry,
// rate limiting, or Retry-After handling should wrap their HTTP client with
// an appropriate http.RoundTripper before passing it in. A nil httpClient
